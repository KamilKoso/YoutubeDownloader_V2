...
let AuthService = class AuthService {
    ...
    register(credentials) {
        return this._http
            .post(`${this._identityUrl}/register`, credentials)
            .pipe(switchMap((result) => this._http.post(`${appConfig.apiUrl}/user/register`, { id: result.userId, name: credentials.username })));
    }
    login() {
