    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<CookieAuthenticationOptions>(IdentityConstants.TwoFactorRememberMeScheme,
                options =>
                {
                    options.Cookie.Name = "YoutubeDownloader.2faCookie";
                    options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
                });
            ...
            services.Configure<CookieAuthenticationOptions>(IdentityConstants.TwoFactorUserIdScheme,
                options =>
                {
                    options.Cookie.Name = "YoutubeDownloader.2faUserIdCookie";
                    options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
                });
            ...
            services.Configure<CookieAuthenticationOptions>(IdentityConstants.ExternalScheme,
                options =>
                {
                    options.Cookie.Name = "YoutubeDownloader.External";
                    options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
                });

            services.AddAntiforgery(options =>
            {
                options.Cookie.Name = "YoutubeDownloader.Antiforgery";
                options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
            });

            services.Configure<CookieTempDataProviderOptions>(options =>
            {
                options.Cookie.Name = "YoutubeDownloader.TempCookie";
                options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
            });
